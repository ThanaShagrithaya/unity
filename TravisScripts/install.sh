...
curl --retry 5 -o Unity.pkg https://download.unity3d.com/download_unity/5f859a4cfee5/MacEditorInstaller/Unity.pkg
#2019.4.0f1 Failing activation
#curl --retry 5 -o Unity.pkg https://download.unity3d.com/download_unity/0af376155913/MacEditorInstaller/Unity.pkg
